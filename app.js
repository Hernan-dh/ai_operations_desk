...
const translations = {
  en: {
    connection: 'Connection', simulation: 'Simulation', live: 'n8n live', eyebrow: 'AUDITABLE AUTOMATION / CASE 001',
  ...
  es: {
    connection: 'Conexión', simulation: 'Simulación', live: 'n8n activo', eyebrow: 'AUTOMATIZACIÓN AUDITABLE / CASO 001',
...
const elements = Object.fromEntries(['triageForm','requestText','resultPanel','emptyState','loadingState','resultContent','errorState','errorMessage','caseId','category','priority','review','summary','nextAction','missing','sourceTitle','sourceExcerpt','sourceId','auditTrail','languageButton','connectionButton','connectionDialog','connectionForm','webhookUrl','modeLabel'].map((id) => [id, document.getElementById(id)]));
